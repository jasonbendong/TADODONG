...
class PackageMeal(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.add_package_meal_button = tk.Button(self, text="Add Package", font=("Lucida Console",12,"bold"),bd=6, width = 16, bg="lightslategray", fg="white", command=self.add_package_meal)
        self.add_package_meal_button.place(x=700, y=450, width=300, height=70)
        
        self.delete_package_meal_button = tk.Button(self, text="Delete Package", font=("Lucida Console",12,"bold"),bd=6, width = 16, bg="lightslategray", fg="white", command=self.delete_package_meal)
...
class PackageService(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.add_package_service_button = tk.Button(self, text="Add Package", font=("Lucida Console",12,"bold"),bd=6, width = 16, bg="lightslategray", fg="white", command=self.add_package_service)
        self.add_package_service_button.place(x=700, y=450, width=300, height=70)
        
        self.delete_package_service_button = tk.Button(self, text="Delete Package", font=("Lucida Console",12,"bold"),bd=6, width = 16, bg="lightslategray", fg="white", command=self.delete_package_service)
